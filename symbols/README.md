...
| `INA240.kicad_sym` | [22] | UNVERIFIED PLACEHOLDER pin numbering (no local datasheet copy) |
| `IRFB4110PBF.kicad_sym` | [20] | Standard TO-220AB G/D/S pinout convention; ratings unverified |
...
| `WE_SHC_3671375.kicad_sym` | [15], [19] | Mechanical shield can — no functional schematic pins (placeholder GND-bond pin only) |
