...
| `MSPM0G3518_Q1_RHB_TILT.kicad_sym` | [44] | VERIFIED (all 32 RHB pins, [44] Fig. 6-6 / Table 6-2 read 2026-09-17); the RHB MCU with pins named by their role in `builds/6s/10A/BRUSHED_CAN_485_isolation/` — includes PA7/PA22/PA26/PA27, which `MSPM0G3518_Q1_RHB` omits |
